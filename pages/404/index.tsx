...
import img1 from '../../public/images/background/10.jpg';
  ...
  return (
    <>
      ...
      <div className="maincontent">
        ...
        {/* home */}
        <section id="section-hero" className="comingsoon pt50 pb50 vertical-center" aria-label="section">
            ...
            <div className="container">
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-6 text-center">
                        <Image src={img2} className="lazy img-fluid anim-up-down" alt="404"/>
                    </div>
                </div>
            </div>
        </section>
