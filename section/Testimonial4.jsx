      ...
      <div className="row g-2">
        <div className="col-lg-4 wow fadeInUp" data-wow-delay=".2s">
          <div className="de-image-text">
            ...
            <img src="../../images/misc/p1.jpg" className="img-fluid" alt="" />
          </div>
        </div>
        ...
        <div className="col-lg-4 wow fadeInUp" data-wow-delay=".4s">
          <div className="de-image-text">
            ...
            <img src="../../images/misc/p2.jpg" className="img-fluid" alt="" />
          </div>
        </div>
        ...
        <div className="col-lg-4 wow fadeInUp" data-wow-delay=".6s">
          <div className="de-image-text">
            ...
            <img src="../../images/misc/p3.jpg" className="img-fluid" alt="" />
          </div>
        </div>
      </div>
    </div>
